# SNU Appendard v0.1.1

Maintenance release of SNU Appendard — a Pretendard-derived OpenType/CFF font family that pairs Pretendard's Hangul and CJK glyphs with Inter's Latin outlines, including true Inter italic forms.
...
The release ZIP is `SNUAppendard-v0.1.1.zip` and contains 18 static OTF files under `otf/`:
